    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span><%=s1.getName() %></span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="seller-profile.jsp">Profile</a></li>
              <li><a href="seller-change-pswd.jsp">Change Password</a></li>
              <li><a href="seller-logout.jsp">Log out</a></li>
            </ul>
          </li>
